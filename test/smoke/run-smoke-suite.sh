...
PYTEST_PARAMS=$(echo "${PYTEST_PARAMS:---allure-features=Node --deselect=tests/mitigation_controls/test_llm_mitigations.py::TestLLMMitigations::test_llm_detect_session_works}" | xargs)
